...
EL system is judged on two test sets: 1. [CORD-NERD](https://drive.google.com/file/d/1uJgtqqggkVXv7uGLuG3wYWstIaa7bqRO/view?usp=sharing) Test set or UMLS-based Test and 2. Manually annotated test set. These data sets are available from the following links. 
